...
const servicesData: ServiceItem[] = [
  ...
  },
  {
    ...
    image: serviceImg1,
    images: [odblysniki1, odblysniki2],
...
const faqData: FAQItem[] = [
  {
    id: 'faq-seo-1',
    question: 'Na czym dokładnie polega regeneracja odbłyśników i proces metalizacji?',
    answer: 'Profesjonalna regeneracja odbłyśników to złożony proces regeneracji, który w pierwszej fazie polega na całkowitym usunięciu zniszczonej powłoki aluminium wraz z podkładem. Następnie na detal aplikuje się warstwę termoodpornego podkładu. Właściwy proces metalizacji próżniowej odbywa się w specjalnej komorze próżniowej, gdzie detal w trakcie metalizacji próżniowej jest pokrywany cienka warstwą aluminium wysokiej czystości. Następnie w określony sposób nałożenie zabezpieczającego lakieru tworzy trwałą powłokę ochronną. Tak uzyskane powłoki gwarantują idealne odbicie światła. Alternatywny proces metalizacji natryskowej znajduje zastosowanie przy innych materiałach.',
    category: 'technology'
  },
  {
    id: 'faq-1',
        ...
        <section className="bg-white py-24 border-t border-gray-100">
          <div className="max-w-4xl mx-auto px-6 sm:px-12 text-gray-600 font-sans">
            ...
            <div className="space-y-6 text-sm sm:text-base leading-relaxed">
              ...
              <p>Założycielem i głównym technologiem firmy jest ekspert z wieloletnim doświadczeniem w branży obróbki cieplnej i powierzchniowej. To właśnie z jego nazwiskiem utożsamiana jest nasza jakość i precyzja. Wybierając naszą firmę, decydujesz się na współpracę, nad którą pieczę trzyma firma <strong>metalizacja próżniowa dariusz staniak</strong>, gwarantująca najwyższe standardy obsługi od projektu po finalną produkcję masową.</p>

              <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Lokalizacja i zaplecze technologiczne</h3>
              <p>Nasza infrastruktura pozwala na obsługę zarówno krótkich serii produkcyjnych, jak i wielkonakładowych zleceń dla przemysłu motoryzacyjnego czy kosmetycznego. Główny zakład znajduje się w centralnej Polsce, w doskonałym punkcie logistycznym. Jeśli szukasz rzetelnego partnera biznesowego, to <strong>metalizacja próżniowa józefów</strong> stanowi najlepszy adres na mapie podwykonawców przemysłowych.</p>
