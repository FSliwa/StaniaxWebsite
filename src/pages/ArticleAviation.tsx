    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <main className="pt-24 pb-20">
        ...
        <section className="relative w-full h-[50vh] min-h-[400px] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-full p-6 lg:p-12">
            <div className="container mx-auto max-w-4xl space-y-4">
              ...
              <p className="text-white/70 text-sm md:text-base max-w-2xl italic leading-relaxed">
        ...
        <section className="container mx-auto px-6 lg:px-12 mt-12">
          <div className="grid gap-12 lg:grid-cols-[1fr_320px] items-start max-w-6xl mx-auto">
            ...
            <article className="space-y-8 text-muted-foreground leading-relaxed text-base md:text-lg">
              ...
              <div className="space-y-6">
                <p>
                  Współczesny przemysł produkcyjny nieustannie poszukuje rozwiązań, które łączą w sobie dwie kluczowe cechy: wysoką wytrzymałość mechaniczną oraz nienaganną estetykę. W świecie, w którym redukcja kosztów i optymalizacja wagi komponentów stają się priorytetem, tradycyjne metody wytwarzania gabarytowych, w pełni metalowych elementów ustępują miejsca nowoczesnym technologiom inżynierii powierzchni. Jednym z najważniejszych procesów w tej dziedzinie jest nowoczesna metalizacja. Obecnie to właśnie profesjonalna metalizacja próżniowa oraz powiązane z nią metalizowanie próżniowe rewolucjonizują podejście do projektowania detali.
                </p>
                <p>
                ...
                <div className="space-y-3 pl-4 border-l-2 border-accent/35">
                  ...
                  <p>
                    ...
                    <a 
                      ...
                      className="inline-flex items-center text-accent hover:underline font-medium"
                    >
                      Staniax <ArrowUpRight className="inline-block w-4 h-4 ml-0.5" />
                    </a>{' '}
                    - metalizacja próżniowa, metalizowanie lakierowanie tworzyw sztucznych to obszary, w których synergia procesów decyduje o ostatecznym sukcesie produktu. Przykładem lidera w tej dziedzinie, u którego nowatorskie podejście wyznaczyło nowe trendy w branży metalizacji próżniowej jest{' '}
                    <a 
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p>
                      Utlenianie i degradacja powierzchni to główny wróg wielu materiałów. Nowoczesna metalizacja próżniowa przy użyciu aluminium tworzy niezwykle szczelną, mikroskopijną barierę odcinającą dostęp czynników zewnętrznych do podłoża. Dzięki precyzyjnemu osadzaniu atomów metalu w komorze próżniowej, uzyskana powłoka doskonale przylega to powierzchni. Ponieważ w grę wchodzi profesjonalna metalizacja aluminium, powierzchnia zyskuje pełną pasywację i wysoki stopień ochrony. Jest to rozwiązanie znacznie trwalsze i bardziej jednorodne niż klasyczne, jednowarstwowe powłoki malarskie.
                    </p>
                  </div>
            ...
            <aside className="space-y-8 sticky top-28">
              ...
              <Card className="border border-accent/20 bg-slate-950 text-white relative overflow-hidden">
                ...
                <CardContent className="p-6 space-y-4">
                  <h4 className="text-xs uppercase tracking-[0.3em] text-accent font-semibold">
