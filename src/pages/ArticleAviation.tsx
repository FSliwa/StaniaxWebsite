...
const articleContent = {
  pl: {
    ...
    lead: 'Jak metalizacja wpływa na wydajność materiałów? Odkryj jej tajniki! Dowiedz się o jej rodzajach i zastosowaniach w różnych branżach. Naucz się więcej!',
  ...
  en: {
    ...
    lead: 'How Surface Treatments Affect Material Performance? Discover Metallization! Discover how advanced PVD protective coatings and vacuum deposition increase material performance across industries. Find out the details of our strategic partnership!',
  ...
  de: {
    ...
    lead: 'Wie beeinflusst Metallisierung die Materialleistung? Entdecken Sie ihre Geheimnisse! Erfahren Sie mehr über ihre Arten und Anwendungen in verschiedenen Branchen. Lernen Sie mehr!',
