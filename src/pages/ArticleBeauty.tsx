...
const articleContent = {
  pl: {
    ...
    lead: 'Metalizacja próżniowa rewolucjonizuje branżę beauty. Jak nowoczesna metalizacja próżniowa oraz precyzyjne lakierowanie tworzyw i szkła zmieniają rynek opakowań kosmetycznych w tym segmencie?',
  ...
  en: {
    ...
    lead: 'Vacuum Metallization Revolutionizes the Beauty Industry. How modern vacuum metallization and precise plastic and glass painting are changing the cosmetics packaging market in the beauty segment?',
